  ...
  if (status === "authenticated") {
    return (
      <div className="bg-grayLight min-h-screen">
        <div className="fixed z-30 md:z-10 md:relative pb-3 w-full bg-white md:hidden flex px-2 py-2">
        ...
        <div className="pt-[101.59px] md:pt-0 grid grid-cols-7 divide-y divide-gray-300 lg:grid-cols-10">
          ...
          <div className=" flex flex-col items-stretch flex-grow sm:max-h-screen sm:overflow-auto col-span-7 md:col-span-5 lg:col-span-8 bg-grayLight ">
            <Header />
            <div className="sm:max-h-screen sm:overflow-auto px-2 pb-4 pt-[101.59px] md:pt-4 md:pr-4 md:pl-6 ">
              {children}
            </div>
          </div>
        </div>
